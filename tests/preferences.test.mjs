...
const saved={provider:'gemini',openaiModel:'gpt-5.6-luna',geminiModel:'gemini-3.1-flash-lite',reasoningEffort:'high',thinkingLevel:'minimal',outputFormat:'narrative'};
